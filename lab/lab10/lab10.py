...
def calc_eval(exp):
    ...
    if isinstance(exp, Pair):
        # UPDATE THIS FOR Q2, e.g (+ 1 2), + is the operator
        operator = exp.first
        # UPDATE THIS FOR Q2, e.g (+ 1 2), 1 and 2 are operands
        operands = exp.rest
        ...
        # UPDATE THIS FOR Q4, how do you access a variable?
        return bindings[exp]
